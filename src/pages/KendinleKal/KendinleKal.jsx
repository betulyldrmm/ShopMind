...
const KendinleKal = () => {
  ...
  useEffect(() => {
    ...
    fetchKendinleKalProducts();
  }, []);

  const fetchKendinleKalProducts = async () => {
    try {
      setLoading(true);
      ...
      <>
        ...
        <div className="kendine-hediye-container">
          <div className="loading-spinner">
            ...
            <p>Kendinle Kal ürünleri yükleniyor...</p>
          </div>
        </div>
      </>
    );
        ...
        <div className="page2-header">
          <div className="headerr-content">
            ...
            <p className="headerr-subtitle">
              İçsel huzurunu bul, kendine zaman ayır.
              {user && <span> Hoş geldin, <strong>{user.username}</strong>!</span>}
            </p>
            {products.length > 0 && (
              <p className="product-count">
                📦 {products.length} huzur ürünü bulundu
              </p>
            )}
          </div>
          ...
          <div className="motivationn-cards">
            <div className="motivationn-card">
              ...
              <h3>Dinginlik</h3>
              <p>Günlük hayatın yoğunluğunda kendine sakin bir alan yarat.</p>
            </div>
            <div className="motivationn-card">
              <span className="motivationn-icon">🕯️</span>
              <h3>Ruhunu Dinle</h3>
              <p>Bir mum yak, derin bir nefes al ve düşüncelerini serbest bırak.</p>
            </div>
            <div className="motivationn-card">
              <span className="motivationn-icon">☁️</span>
              <h3>Zihnini Hafiflet</h3>
              <p>Kendinle baş başa kaldığında stres azalır, huzur artar.</p>
            </div>
          </div>
        </div>
        ...
        <div className="productss-section">
          {filteredProducts.length === 0 ? (
            <div className="no-productss">
              ...
              <h3>
                {searchTerm ? 'Aradığın huzur ürünü bulunamadı' : 'Henüz huzur ürünü yok'}
              </h3>
              <p>
                {searchTerm 
                  ? 'Farklı arama terimleri veya filtreler deneyebilirsin'
                  : 'Kendinle Kal kategorisinde henüz ürün bulunmuyor'
                }
              </p>
              <button 
                onClick={() => {
                  ...
                  <div className="product-info">
                    ...
                    <div className="product-actions">
                      <button 
                        ...
                        className={product.stock > 0 ? 'ad2-to-cart-btn' : 'ad2-to-cart-btn disabled'}
                      >
